...
export default class PathList {
  ...
  constructor(S) {
    ...
    this.disposables.add(
      ...
      atom.commands.add(this.slv.element, {
        ...
        'fuzzy-files:update': () => { this.refresh() }
      }),
  ...
  getInfoMessage() {
    ...
    return ['Press ', <span class='keystroke'>Enter</span>, ', ', <span class='keystroke'>Alt|Ctrl-Enter</span>, ', ', <span class='keystroke'>Alt-Left|Right|Up|Down</span>, ', ', <span class='keystroke'>Alt-C|V Alt-P|A|R|N</span>, ', ', <span class='keystroke'>Alt-D</span>, ' or ', <span class='keystroke'>Alt-0|/|\|Q|S</span>]
  }
  ...
  //   return [
  //     'Press ',
  //     $(Keystroke, { keys:'Enter', tooltip:`
  //     - Enter: opens the selected file in Pulsar or changes the query if it is a directory<br>
  //     `}),
  //     ', ',
  //     $(Keystroke, { keys:'Alt|Ctrl-Enter', tooltip:`
  //     - Alt-Enter: opens the selected file externally<br>
  //     - Ctrl-Enter: shows the given file in a file manager<br>
  //     `}),
  //     ', ',
  //     $(Keystroke, { keys:'Alt-Left|Right|Up|Down', tooltip:`
  //     - Alt-Left: opens the selected file by splitting to the left<br>
  //     - Alt-Right: opens the selected file by splitting to the right<br>
  //     - Alt-Up: opens the selected file by splitting upwards<br>
  //     - Alt-Down: opens the selected file by splitting downwards<br>
  //     `}),
  //     ', ',
  //     $(Keystroke, { keys:'Alt-C|V Alt-P|A|R|N', tooltip:`
  //     - Alt-V Alt-P: inserts the project path of the selected file<br>
  //     - Alt-V Alt-A: inserts the absolute path of the selected file<br>
  //     - Alt-V Alt-R or Alt-V: inserts the relative path of the selected file to the opened file<br>
  //     - Alt-V Alt-N: inserts the name of the selected file<br>
  //     - Alt-C Alt-P: copies the project path of the selected file<br>
  //     - Alt-C Alt-A: copies the absolute path of the selected file<br>
  //     - Alt-C Alt-R or Alt-C: copies the relative path of the selected file to the opened file<br>\
  //     - Alt-C Alt-N: copies the name of the selected file<br>\
  //     `}),
  //     ', ',
  //     $(Keystroke, { keys:'Alt-D', tooltip:`
  //     - Alt-D: move file to trash<br>
  //     `}),
  //     ' or ',
  //     $(Keystroke, { keys:'Alt-0|/|\|Q|S', tooltip:`
  //     - Alt-0: changes the separator in the insert to the system default (does not hide the view)<br>
  //     - Alt-/: changes the separator in the insert to / (does not hide the view)<br>
  //     - Alt-\: changes the separator in the insert to \ (does not hide the view)<br>
  //     - Alt-Q: changes the query to the project file path of the selected item (does not hide the view)<br>
  //     - Alt-S: changes the query to the selection (does not hide the view)<br>
  //     `}),
  //   ]
  // }
  ...
  updateQueryFromSelection() {
    ...
    this.slv.refs.queryEditor.setSelectedBufferRange([[0, 0], [0, text.length]])
  }
  ...
  elementForItem (item, options) {
    ...
    let iconClass = this.S.getIconClass ? this.S.getIconClass(item.aPath) : 'icon-file-text'
  ...
  refresh() {
    this.S.pathData.loadQ = true ; this.update()
  }
  ...
  update() {
    if (this.S.pathData.loadQ) {
      ...
      this.S.pathData.cache(() => {
        ...
        this.slv.update({items:this.S.pathData.items, loadingMessage:null, infoMessage:this.getInfoMessage()})
      })
...
class Keystroke {
  ...
  constructor(props) {
    ...
    this.element.classList.add('keystroke')
    if (props.keys) {
      this.element.innerHTML = props.keys
    }
    if (props.tooltip) {
      this.disposables.add(atom.tooltips.add(this.element, { title:props.tooltip, placement:'bottom' }))
    }
  }
